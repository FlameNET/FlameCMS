...
<div class="article-wrapper">
		<a href="<?php echo BASE_URL.'blog/'.$articles['id'].'/'.CleanString($articles['title']); ?>/" class="featured-news-link" data-category="wow" data-action="Blog_Click-Throughs" data-label="home 0 - eu - 12383903 - 12492647">
	...
	<div class="article-meta">
		<a href="<?php echo BASE_URL.'blog/'.$articles['id'].'/'.CleanString($articles['title']); ?>/#comments" class="comments-link"><?php echo $articles['comments']; ?></a>
